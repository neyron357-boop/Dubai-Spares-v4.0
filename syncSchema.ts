export const ORDER_GRAPH_COLUMNS = [
  'id','brand','model','year','body_type','vin','vin_photo_url','google_drive_folder_url','priority','client_name','source','car_photo_url','car_photos','markup_percent','markup_type','markup_fixed_aed','discount_type','discount_percent','discount_fixed_aed','use_markup_as_default_for_new_parts','client_currency','fx_updated_at','logistics','cargo_country','delivery_aed','packing_aed','service_fee_aed','exchange_rate','created_at','is_archived','is_sold','sold_profit_usd','is_vip','is_pinned','is_lead','customer_status','status_changed_at','status_changed_by','notes','status','sales_status','payment_status','search_deposit_status','search_deposit_amount','search_deposit_currency','search_deposit_exchange_rate','search_deposit_amount_aed','search_deposit_paid_at','customer_contact','social_nickname','contact_links','updated_at','recommended_shop_ids','dismissed_shop_ids','lead_unread','lead_source','lead_read_at','pricing_events','vendor_contacts','vendor_checklist','vehicle_details','hunt_status','public_quote_token'
] as const;
