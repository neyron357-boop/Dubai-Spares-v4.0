        ...
        <div className={`min-h-[52dvh] rounded-t-[30px] bg-[#F4F1EA] px-4 pt-6 text-[#171717] shadow-[0_-18px_60px_rgba(0,0,0,0.28)] ${activeTab === 'search' || activeTab === 'notes' || activeTab === 'finance' ? 'pb-[calc(9.5rem+env(safe-area-inset-bottom))]' : 'pb-8'}`}>
          ...
          {activeTab === 'search' && (
            <div className="ds-mode-enter space-y-6">
              ...
              <form
                ...
                className="fixed inset-x-0 bottom-0 z-40 w-screen border-t border-stone-200/70 bg-[#F4F1EA]/96 px-3 pb-[calc(10px+env(safe-area-inset-bottom))] pt-2 shadow-[0_-18px_44px_rgba(23,23,23,0.16)] backdrop-blur-xl"
              >
                {newPartKind === 'group' && (
          ...
          {activeTab === 'finance' && (
            <div className="ds-mode-enter space-y-5">
              ...
              <div className="fixed inset-x-0 bottom-0 z-40 w-screen border-t border-stone-200/70 bg-[#F4F1EA]/96 px-3 pb-[calc(10px+env(safe-area-inset-bottom))] pt-2 shadow-[0_-18px_44px_rgba(23,23,23,0.16)] backdrop-blur-xl">
                <div className="grid grid-cols-4 gap-2">
