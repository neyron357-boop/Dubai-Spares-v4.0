      ...
      <section className="rounded-2xl border border-emerald-400/30 bg-emerald-400/10 p-3 space-y-3">
        ...
        <div className="space-y-1 text-[10px]">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button type="button" onClick={() => setBrandMatchMode((v) => (v === 'strict' ? 'soft' : 'strict'))} className="inline-flex items-center gap-1 rounded-lg border border-slate-600 px-3 py-1 font-black uppercase text-slate-300">Brand strict: {brandMatchMode}<HelpCircle size={11} /></button>
            {uxMode === 'advanced' && <button type="button" onClick={() => setFallbackNearby((v) => !v)} className="inline-flex items-center gap-1 rounded-lg border border-amber-400/40 px-3 py-1 font-black uppercase text-amber-200"><Telescope size={11} /> fallback nearby<HelpCircle size={11} /></button>}
          </div>
        </div>
        ...
        return (
          <article key={shop.id} className="rounded-2xl border border-slate-800 bg-slate-900/80 p-3 space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button type="button" onClick={() => void openCalls(shop.phone, bestEntry)} className="inline-flex items-center gap-1 rounded-xl border border-slate-600 px-3 py-2 text-[11px] font-black uppercase text-slate-200"><PhoneCall size={12} /> Звонок</button>
