...
const clearApplicationStorage = async () => {
  ...
  let shouldLogBootCleanup = false;
  try {
    shouldLogBootCleanup = window.localStorage.getItem('dubai-spares-show-public-debug') === '1';
  } catch {
    shouldLogBootCleanup = false;
  }

  if (bootCleanupErrors.length > 0 && shouldLogBootCleanup) {
