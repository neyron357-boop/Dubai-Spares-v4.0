...
export const CAR_DATABASE: Record<string, CarBrandCatalog> = {
  ...
  Ford: { models: ['Bronco', 'EcoSport', 'Edge', 'Escape', 'Everest', 'Explorer', 'Expedition', 'F-150', 'Focus', 'Fusion', 'Maverick', 'Mustang', 'Ranger', 'Taurus'], bodyTypes: ['Sedan', 'SUV', 'Pickup', 'Coupe', 'Hatchback'] },
